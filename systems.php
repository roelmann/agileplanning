...
<header class="pageheader jumbotron text-center">
    ...
    <div class="main-content">
       <table class="table table-striped">
          ...
          ?>
              <tr class="table-row">
                <td contenteditable="false"><?php echo $sys[$k]["id"]; ?></td>
        ...
        <form action="newsys.php?t=system" method="post">
            <tr class="table-row">
                ...
                <td>*<input type="text" name="system" value="" /></td>
                <td><input type="text" name="productowner" value="" /></td>
                <td><input type="text" name="customercontact" value="" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" name="submit" value="&#xf0c7;" class="fa"></td>
            </tr>
        </form>
