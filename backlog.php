                ...
                if (count($backlog) > 0) {
                    ...
                    foreach($backlog as $k=>$v) { // Loop through all backlog items from filtered search.
                        ...
                        <tr class="table-row" width="100%">
                            ...
                            <td class="maxwidth32" contenteditable="true" onBlur="saveToDatabase(this, '<?php echo $table; ?>', 'Releasability','<?php echo $backlog[$k]["id"]; ?>')" onClick="showEdit(this);"><?php echo $backlog[$k]["Releasability"]; ?></td>
